...
Virtual function, to be implemented in the subclass filters. Read data from input filter, process the data, and write the result to the output port. \hypertarget{classFilter_ae089d87624ac09bedb2f14c828883059}{\index{Filter@{Filter}!set\-Prop@{set\-Prop}}
